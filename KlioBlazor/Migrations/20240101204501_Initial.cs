        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBirthExact = table.Column<bool>(type: "bit", nullable: false),
                    DateOfDeath = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateOfDeathExact = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Partitions_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Creators_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleaseDateExact = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    PatitionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Movies_Partitions_PatitionId",
                        column: x => x.PatitionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieInfos_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesCreators", x => new { x.MovieId, x.CreatorID });
                    table.ForeignKey(
                        name: "FK_MoviesCreators_Creators_CreatorID",
                        column: x => x.CreatorID,
                        principalTable: "Creators",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviesCreators_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviesKeywords", x => new { x.MovieId, x.KeywordId });
                    table.ForeignKey(
                        name: "FK_MoviesKeywords_Keywords_KeywordId",
                        column: x => x.KeywordId,
                        principalTable: "Keywords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviesKeywords_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Creators_CountryId",
                table: "Creators",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieInfos_MovieId",
                table: "MovieInfos",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_Movies_PatitionId",
                table: "Movies",
                column: "PatitionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesCreators_CreatorID",
                table: "MoviesCreators",
                column: "CreatorID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviesKeywords_KeywordId",
                table: "MoviesKeywords",
                column: "KeywordId");

            migrationBuilder.CreateIndex(
                name: "IX_Partitions_CategoryId",
                table: "Partitions",
                column: "CategoryId");
        }
